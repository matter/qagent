...
_PERFORMANCE_INDEX_DDLS = [
    ...
    "CREATE INDEX IF NOT EXISTS idx_daily_bars_market_ticker_date ON daily_bars(market, ticker, date)",
    "CREATE INDEX IF NOT EXISTS idx_daily_bars_market_date ON daily_bars(market, date)",
    "CREATE INDEX IF NOT EXISTS idx_factor_eval_market_factor_created ON factor_eval_results(market, factor_id, created_at)",
    "CREATE INDEX IF NOT EXISTS idx_models_market_created ON models(market, created_at)",
    "CREATE INDEX IF NOT EXISTS idx_backtest_market_created ON backtest_results(market, created_at)",
    "CREATE INDEX IF NOT EXISTS idx_backtest_market_strategy_created ON backtest_results(market, strategy_id, created_at)",
    "CREATE INDEX IF NOT EXISTS idx_signal_runs_market_created ON signal_runs(market, created_at)",
    "CREATE INDEX IF NOT EXISTS idx_signal_runs_market_strategy_created ON signal_runs(market, strategy_id, created_at)",
